...
Depends on: [`AgentBackend`](subsystems/session.zh.md) · [`AgentOptions`](subsystems/core.zh.md) · [`SessionId`](subsystems/core.zh.md)
...
来源： [`packages/core/pi-agent-loop/src/index.ts:61`](../packages/core/pi-agent-loop/src/index.ts)
...
来源： [`packages/a2a/a2a/src/index.ts:39`](../packages/a2a/a2a/src/index.ts)

<a id="reachforstardsh-a2a-host"></a>

## `@reachforstar/dsh-a2a-host`

依赖： `sessionController`
...
依赖于： [`AgentSkill`](../packages/a2a/a2a/src/index.ts)

来源： [`packages/a2a/a2a-host/src/index.ts:35`](../packages/a2a/a2a-host/src/index.ts)

<a id="reachforstardsh-fs-sftp"></a>

## `@reachforstar/dsh-fs-sftp`

依赖： `sshSftp` · `sandboxPolicy`
...
来源： [`packages/remote/fs-sftp/src/index.ts:39`](../packages/remote/fs-sftp/src/index.ts)
...
- `@reachforstar/dsh-tool-a2a` — 需要 `tools` · `a2a`（[`packages/a2a/tool-a2a/src/index.ts`](../packages/a2a/tool-a2a/src/index.ts)）
