...
export const zh = {
  ...
  builtinBrowserUseTitle: '浏览器自动化',
  builtinBrowserUseDescription: '启用浏览器自动化工具，由 Playwright MCP 驱动 Chromium。',
  builtinComputerUseTitle: '计算机操作',
  builtinComputerUseDescription: '启用桌面自动化工具，通过 Cua Driver 读取屏幕并操作指针与键盘。',
  statusProblem: '异常',
  statusBeta: 'Beta',
  reasonLabel: '原因',
...
export const en = {
  ...
  builtinBrowserUseTitle: 'Browser Use',
  builtinBrowserUseDescription: 'Enable browser automation tools driven by Playwright MCP.',
  builtinComputerUseTitle: 'Computer Use',
  builtinComputerUseDescription: 'Enable desktop automation tools through the Cua Driver.',
