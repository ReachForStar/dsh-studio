...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PressureTriggerOptions: 'compaction.md',
  ...
  FsRemoveOptions: 'filesystem.md',
  FsRemoveOutcome: 'filesystem.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SshConnectionDefinition: 'ssh definition record is owned by packages/remote/ssh/README.md',
  SshConnectionId: 'ssh definition identity is owned by packages/remote/ssh/README.md',
  SshDefinitionView: 'ssh secret-free wire view is owned by packages/remote/ssh/README.md',
  SshExecRequest: 'ssh exec request is owned by packages/remote/ssh/README.md',
  SshExecSpec: 'ssh resolved exec spec is owned by packages/remote/ssh/README.md',
  SshRunResult: 'ssh exec outcome is owned by packages/remote/ssh/README.md',
  SshTestResult: 'ssh probe outcome is owned by packages/remote/ssh/README.md',
  ...
  AgentCard: 'a2a.md',
  A2APeerConfig: 'a2a.md',
  A2APeerInfo: 'a2a.md',
  A2APeerRef: 'a2a.md',
  A2APeerReply: 'a2a.md',
  A2ASendRequest: 'a2a.md',
  WorkspaceFileDeletion: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
  WorkspaceFileDeleteOptions: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
  WorkspaceFileStat: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
  WorkspaceFileWriteGuard: 'Host workspace file endpoint contract is owned by packages/api/workspace-files/README.md',
