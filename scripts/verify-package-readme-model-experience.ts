...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-polish': { kind: 'none', reason: 'Browser-side presentation plus host HTTP/settings plumbing; registers nothing model-facing (the excalidraw tools live in dsh-tool-excalidraw).' },
